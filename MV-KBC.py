...
def res50_model(n):
    ...
    x = Dropout(0.5)(x)
    predictions = Dense(2, activation='relu', name = 'dense3_'+ str(n))(x)
...
def build_model(k):
    ...
    merged1 = Dense(2, activation='relu', name='KBC_v1')(merged1)
    print 'view1'
    # view 2
    ...
    merged2 = Dense(2, activation='relu', name='KBC_v2')(merged2)
    print 'view2'
    # view 3
    ...
    merged3 = Dense(2, activation='relu', name='KBC_v3')(merged3)
    print 'view3'
    # view 4
    ...
    merged4 = Dense(2, activation='relu', name='KBC_v4')(merged4)
    print 'view4'
    # view 5
    ...
    merged5 = Dense(2, activation='relu', name='KBC_v5')(merged5)
    print 'view5'
    # view 6
    ...
    merged6 = Dense(2, activation='relu', name='KBC_v6')(merged6)
    print 'view6'
    # view 7
    ...
    merged7 = Dense(2, activation='relu', name='KBC_v7')(merged7)
    print 'view7'
    # view 8
    ...
    merged8 = Dense(2, activation='relu', name='KBC_v8')(merged8)
    print 'view8'
    # view 9
    ...
    merged9 = Dense(2, activation='relu', name='KBC_v9')(merged9)
    print 'view9'
